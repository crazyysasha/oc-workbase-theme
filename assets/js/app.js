...
alpinejs__WEBPACK_IMPORTED_MODULE_0__.default.store('theme', {
  data: {
    darkMode: false
  },
  init: function init() {
  ...
  toggleDarkMode: function toggleDarkMode() {
    localStorage.setItem('theme', JSON.stringify(_objectSpread(_objectSpread({}, this.data), {}, {
      darkMode: this.data.darkMode = !this.data.darkMode
    })));
  }
});
alpinejs__WEBPACK_IMPORTED_MODULE_0__.default.data('multiselect', function (items) {
  ...
  return {
    ...
    selected: [],
    isOpen: false,
    toggle: function toggle(event, item) {
    ...
    init: function init() {
      this.items = items;
      this.selected = items.filter(function (item) {
...
if (alpinejs__WEBPACK_IMPORTED_MODULE_0__.default.store.modals === undefined) {
  alpinejs__WEBPACK_IMPORTED_MODULE_0__.default.store.modals = {};
}

alpinejs__WEBPACK_IMPORTED_MODULE_0__.default.directive('modal', function (el, _ref, _ref2) {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkoc_tailpine_theme"] = self["webpackChunkoc_tailpine_theme"] || [];
